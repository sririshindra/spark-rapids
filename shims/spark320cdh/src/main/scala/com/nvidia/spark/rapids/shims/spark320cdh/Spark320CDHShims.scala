...
import com.nvidia.spark.rapids.spark320cdh.RapidsShuffleManager
...
/*
* The Spark320CDHShims class is essentially a copy of Spark320Shims class.
* The reason a copy had to be made instead of directly inheriting Spark320Shims is that
* because of the way the project is structured, it is not possible to make spark320cdh module
* depend on the spark320 module.
 */

class Spark320CDHShims extends Spark32XShims {
